...
class Lexicon:
    ...
    def get_welcome_text() -> str:
        return (
            "🌍 به باندل‌نس (v2rayBundlenesse) خوش آمدید\n\n"
            "مسیر شما به اینترنت آزاد.\n\n"
            "باندل‌نس با استفاده از زیرساخت‌های پرسرعت و پایدار، تجربه‌ای مطمئن برای دسترسی به اینترنت فراهم می‌کند.\n\n"
            "⚡️ فعالسازی فوری\n"
            "🚀 سرعت و پایداری بالا\n"
            ...
            "• وضعیت سرویس‌های خود را مشاهده کنید\n"
            "• راهنمای نصب دریافت کنید\n"
            "• با پشتیبانی در ارتباط باشید\n\n"
            "به باندل‌نس متصل شوید و بدون محدودیت آنلاین بمانید."
        )
    
    SUPPORT = (
        "👨‍💻 <b>پشتیبانی ۲۴ ساعته</b>\n\n"
        "در صورت بروز هرگونه مشکل یا نیاز به مشاوره، لطفاً با پشتیبانی تماس بگیرید:\n"
        "🆔 @AdminUsername"
    )
